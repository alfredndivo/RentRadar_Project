          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">Chat with potential tenants</p>
              </div>
            </div>
            {/* Mobile menu toggle */}
            ...
            <div className="flex-1 overflow-y-auto">
              {filteredChats.length === 0 ? (
                <div className="p-6 text-center">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Tenants will appear here when they contact you</p>
                </div>
              ) : (
                        ...
                        <div className="relative">
                          <div className="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center">
                            <span className="text-white font-semibold">
                              {chat.participant?.name?.charAt(0) || 'T'}
                            </span>
                          </div>
                          {/* Online indicator */}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="relative">
                      <div className="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center">
                        <span className="text-white font-semibold">
                          {selectedChat.participant?.name?.charAt(0) || 'T'}
                        </span>
                      </div>
